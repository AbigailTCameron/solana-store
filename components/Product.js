...
export default function Product({ product }) {
  ...
  return (
    <div className="hover:scale-110 transition duration-150 flex flex-col justify-evenly items-center max-w-[320px] h-[400px] bg-[#341547] rounded-[16px]">

      <div >
        <img className="w-[140px] m-[70px]" src={image_url} alt={name} />
      </div>
