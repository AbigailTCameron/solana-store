      ...
      return (
        <div>
          {item ? (
            ...
            <button disabled={loading} className="text-white w-[90px] font-bold text-[16px] py-[8px] px-[10px] cursor-pointer rounded-lg bg-gradient-to-r from-violet-500 to-fuchsia-500" onClick={processTransaction}>
              Buy now
            </button>
          )}
        </div>
